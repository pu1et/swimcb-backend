...
@WebMvcTestWithoutSecurity(controllers = SearchBoNoticeController.class)
class SearchBoNoticeControllerTest {

  @Autowired
  private MockMvc mockMvc;

  @MockitoBean
  private SearchBoNoticesUseCase useCase;
  ...
  private static class FindNoticesResponseFactory {
    ...
    private static List<FindBoNoticesResponse> create() {
      return List.of(
          FindBoNoticesResponse.builder()
              .noticeId(1L)
              .title("title1")
