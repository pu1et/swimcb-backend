...
@WebMvcTestWithoutSecurity(controllers = FindBoNoticeDetailController.class)
class FindBoNoticeDetailControllerTest {

  @Autowired
  private MockMvc mockMvc;

  @MockitoBean
  private FindBoNoticeDetailUseCase useCase;
  ...
  private static class FindNoticeDetailResponseFactory {
    ...
    private static FindBoNoticeDetailResponse create() {
