...
@WebMvcTestWithoutSecurity(controllers = UpdateBoNoticeIsVisibleController.class)
class UpdateBoNoticeIsVisibleControllerTest {

  @Autowired
  private MockMvc mockMvc;

  @MockitoBean
  private UpdateBoNoticeIsVisibleUseCase useCase;
  ...
  private static class UpdateNoticeIsVisibleRequestFactory {
    ...
    private static UpdateBoNoticeIsVisibleRequest create() {
      return new UpdateBoNoticeIsVisibleRequest(true);
    }
  }
}
