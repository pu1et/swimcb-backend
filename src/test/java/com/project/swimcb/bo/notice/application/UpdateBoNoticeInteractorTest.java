...
class UpdateBoNoticeInteractorTest {

  @InjectMocks
  private UpdateBoNoticeInteractor interactor;
  ...
  private static class UpdateNoticeCommandFactory {
    ...
    private static UpdateBoNoticeCommand create() {
      return new UpdateBoNoticeCommand(1L, "title", "content", true);
    }
  }
}
