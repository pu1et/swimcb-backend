...
class UploadSwimmingPoolImageControllerTest {

  @InjectMocks
  private UploadSwimmingPoolImageController controller;

  @Mock
  private UploadSwimmingPoolImageUseCase useCase;

  private final ObjectMapper objectMapper = new ObjectMapper();

  private MockMvc mockMvc;

  private static final String PATH = "/api/bo/swimming-pools/files/images";
  ...
  void shouldUploadFileSuccessfully() throws Exception {
    ...
    val expectedResponse = UploadSwimmingPoolImageResponse.builder()
        .name("test.jpg")
    ...
    when(useCase.uploadSwimmingPoolImage(any())).thenReturn(expectedResponse);
    // when
    // then
    ...
    verify(useCase, only()).uploadSwimmingPoolImage(mockFile);
  }
