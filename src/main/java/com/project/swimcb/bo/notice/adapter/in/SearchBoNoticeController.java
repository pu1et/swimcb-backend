...
@RestController
@RequestMapping("/api/bo/notices/search")
@RequiredArgsConstructor
public class SearchBoNoticeController {

  private final SearchBoNoticesUseCase useCase;

  @Operation(summary = "공지사항 리스트 제목 검색")
  @GetMapping
  public Page<FindBoNoticesResponse> searchNotices(
