...
@Schema(description = "자유수영 복사 요청")
public record CopyFreeSwimmingRequest(
  ...
  public CopyFreeSwimmingCommand toCommand() {
    return new CopyFreeSwimmingCommand(fromMonth, toMonth);
  }
