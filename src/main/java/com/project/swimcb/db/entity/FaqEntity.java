...
public class FaqEntity extends BaseEntity {
  ...
  private FaqEntity(String title, String content, boolean isVisible) {
    this.title = title;
  ...
  private FaqEntity(long id, String title, String content, boolean isVisible, LocalDateTime createdAt,
